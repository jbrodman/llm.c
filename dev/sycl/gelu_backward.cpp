...
void gelu_backward1(sycl::nd_item<1> id, floatX* dinp, const floatX* inp, const floatX* dout, int N) {
...
void gelu_backward2(sycl::nd_item<1> id, floatX* dinp, const floatX* inp, const floatX* dout, const int N) {
...
void gelu_backward1(floatX* dinp, const floatX* inp, const floatX* dout, int N, const int block_size) {
    ...
    DefaultQueue->parallel_for(sycl::nd_range<1>(grid_size*block_size, block_size), [=](sycl::nd_item<1> id) {
        gelu_backward1(id, dinp, inp, dout, N);
    });
}
...
void gelu_backward2(floatX* dinp, const floatX* inp, const floatX* dout, int N, const int block_size) {
    ...
    DefaultQueue->parallel_for(sycl::nd_range<1>(grid_size*block_size, block_size), [=](sycl::nd_item<1> id) {
        gelu_backward2(id, dinp, inp, dout, N);
    });
}
